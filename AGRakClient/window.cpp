...
LRESULT CALLBACK MainWindowProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
	{
		...
		hWndChild = CreateWindowEx(0, WC_STATIC, TEXT("AGRakClient " RAKSAMP_VERSION),
...
DWORD WINAPI windowThread(PVOID)
{
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, wcex.lpszClassName, TEXT("AGRakClient " RAKSAMP_VERSION),
